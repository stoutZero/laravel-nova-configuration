  ...
  <div class="relative">
    ...
    <div class="flex justify-between">
        <div class="relative h-9 mb-6">
            ...
            <input
              class="appearance-none form-control form-input
                w-search pl-search"
          ...
          <tr dusk="id-row">
            ...
            <td class="td-fit text-right pr-6">
              <span>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" class="fill-current" width="20" height="20" viewBox="0 0 20 20" aria-labelledby="edit" role="presentation"><path d="M4.3 10.3l10-10a1 1 0 0 1 1.4 0l4 4a1 1 0 0 1 0 1.4l-10 10a1 1 0 0 1-.7.3H5a1 1 0 0 1-1-1v-4a1 1 0 0 1 .3-.7zM6 14h2.59l9-9L15 2.41l-9 9V14zm10-2a1 1 0 0 1 2 0v6a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4c0-1.1.9-2 2-2h6a1 1 0 1 1 0 2H2v14h14v-6z"></path></svg>
                </a>
              </span>

              <button
                class="appearance-none cursor-pointer text-70
                  hover:text-primary mr-3"
                data-testid="users-items-0-delete-button"
                dusk="2-delete-button"
                title="Delete"
                @click="askToDelete(configuration)"
              >
    ...
    computed:{
      filtered: function(){
        ...
        return this.configurations.filter(config => {
          return this.isInKey(config, 'key') || this.isInKey(config, 'value')
        })
      }
    },
    ...
    methods:{
      editConfiguration(configuration){
        this.$router.push({
          ...
          params: {
            id: configuration.id, configuration: configuration
          }
        })
      },
      createConfiguration(){
      ...
      deleteConfiguration(){
        axios.delete(
          '/nova-vendor/laravel-nova-configuration/configurations/'
          + this.id_delete
        )
          .then(response => {
